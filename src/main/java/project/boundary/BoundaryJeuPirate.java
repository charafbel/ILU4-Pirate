...
public class BoundaryJeuPirate implements IBoundary{
	...
	@Override
	public void afficherDeplacementPirate(String nomPirate, int positionDepart, int positionArrive) {
		System.out.println("Le pirate "+nomPirate+"se déplace de la case " + positionDepart + "à la case "+positionArrive);
	}
